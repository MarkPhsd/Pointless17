...
import { IPriceCategories, UnitType } from 'src/app/_interfaces/menu/price-categories';
...
import { clientType, IPOSOrder, IPOSPayment, PosOrderItem, PosPayment } from 'src/app/_interfaces';
