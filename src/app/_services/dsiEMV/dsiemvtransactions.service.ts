...
export interface TranResponse {
    ...
    BatchNo: string;
    BatchItemCount: string;
    NetBatchTotal: number | null;
    CreditPurchaseCount: number | null;
    CreditPurchaseAmount: number | null;
    CreditReturnCount: number | null;
    CreditReturnAmount: number | null;
    DebitPurchaseCount: number | null;
    DebitPurchaseAmount: number | null;
    DebitReturnCount: number | null;
    DebitReturnAmount: number | null;
    GetMultipleChoiceResponse: string;
  }
